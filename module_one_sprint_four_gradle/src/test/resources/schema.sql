drop table if exists postsandtags cascade;
...
insert into posts(title, text, image, likesCount) values ('Второе сообщение', 'Бла бла','', 2);
insert into posts(title, text, image, likesCount) values ('третье сообщение', 'Бла бла бла', 'Peschannaya.png',10);
